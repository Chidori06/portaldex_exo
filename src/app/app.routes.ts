...
import { CHARACTERS_PATHS, EPISODES_PATHS, ERROR_PATHS, PLANETES_PATHS, ROOT_PATHS } from './core/constants/paths.constants';
...
export const routes: Routes = [
  ...
  {
    path: PLANETES_PATHS.base,
    loadChildren: async () =>
      import('./features/planetes/planetes.routes').then((module) => module.PLANETES_ROUTES),
  },
  {
